...
/**
 * get_card_position - returns  position based on the card you put in
 * @node: rep card
 * Return: returs card position
 */
...
/**
 * insertion_sort_deck - this sorts a doubly linked deck
 * of integers in ascending order using the Insertion sort algorithm
 * @deck: sorts doubly linked deck
 */
...
/**
 * sort_deck - uses insertion to sort deck
 * @deck: deck
 */
